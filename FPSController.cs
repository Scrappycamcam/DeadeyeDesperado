...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        if (m_IsWalking && m_MoveDir != Vector3.zero)
        {
            myGAObject.GetComponent<Animator>().SetBool("Is Running", false);
        }
        else if (!m_IsWalking)
        {
            myGAObject.GetComponent<Animator>().SetBool("Is Running", true);
        }
        ...
        /*private void Slide(ControllerColliderHit hit)
        {
